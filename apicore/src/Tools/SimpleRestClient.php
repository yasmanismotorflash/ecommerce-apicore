...
class SimpleRestClient
{
    ...
    //--------------------------------------------------------------------------------------------------------
    private $useragent;                                   //Credential agent   //Credential agent simula al de un navegador Firefox 75 en Windows 10
    ...
    private $request_auth_username = null;                //Request Username        //Credential
...
//------------------------------------------------------------------------------------------------------------------------------------
    ...
    public function executeAndExplain()
    {
        ...
        echo '</table> <table><tr> <td class="e" colspan="2" >General Options / Opciones Generales</td> </tr>
                <tr> <td class="e">Credential Agent</td>  <td class="v">' . $this->useragent . '</td></tr>
        ...
        echo '</td></tr>
                ...
                <tr> <td class="e">Request Auth. Credential </td>  <td class="v">' . $this->request_auth_username . '</td></tr> 
