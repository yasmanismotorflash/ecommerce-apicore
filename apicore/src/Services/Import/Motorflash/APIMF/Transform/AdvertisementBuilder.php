...
class AdvertisementBuilder
{
    ...
    static function createAdvertisement(EntityManagerInterface $em, Site $site, ?array $data): ?Advertisement
    {
        if (AdvertisementBuilder::validateArray($data)) {
            ...
            $advertisement = AdvertisementBuilder::setData($advertisement, $em, $site, $data);
    ...
    {
        if (AdvertisementBuilder::validateArray($data)) {
            return AdvertisementBuilder::setData($advertisement, $em, $site, $data);
        }
        return null;
    }


    static function setData(Advertisement $advertisement, EntityManagerInterface $em, Site $site, ?array $data): ?Advertisement
    {
        ...
        $advertisement->setShop(ShopBuilder::getShop($em, $site, $dealer, $data['shop']));
        ...
        $advertisement->setVersion(VersionBuilder::getVersion($em, $site, $model, $data['version']));
        $advertisement->setFinish(FinishBuilder::getFinish($em, $site, $model, $data['finish']));
        $advertisement->setImages(ImageBuilder::loadImages($em, $data['images']));
